...
export class UserServiceService {
  ...
  private readonly propertiesEndPoint = 'http://localhost:8080/shop/api/user/get_properties/'+this.vatNumber;
  private readonly changeRepairStatusEndPoint = 'http://localhost:8080/shop/api/user/repair/repair_status';
  private readonly repairStatusEndPoint = 'http://localhost:8080/shop/api/user/get_repair_status/'+this.vatNumber;
  ...
  getRepairs(){
    ...
    return this.http.get(this.repairStatusEndPoint, { headers: headers })
      .pipe(
        retry(1),
        catchError(error => throwError(() => 'Something is wrong...'))
      );
