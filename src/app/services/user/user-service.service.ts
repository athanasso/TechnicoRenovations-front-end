...
export class UserServiceService {
  ...
  getProperties(){
    ...
    return this.http.get(this.propertiesEndPoint+this.vatNumber, { headers: headers })
      .pipe(
        retry(1),
  ...
  getRepairs(){
    ...
    return this.http.get(this.repairStatusEndPoint+this.vatNumber, { headers: headers })
      .pipe(
        retry(1),
        catchError(error => throwError(() => 'Something is wrong...'))
      );
